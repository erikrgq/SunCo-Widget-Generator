...
const Form = () => {
  ...
  const isCreateConvo = useSelector((state) => state.smoochOpen);
  ...
  const enableSmoochOpen = () => {
    ...
    return `setTimeout(function(){Smooch.open();},${smoochOpen.seconds});`;
  };
